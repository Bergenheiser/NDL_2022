    ...
    <div class="px-6 pt-6 lg:px-8">
        <div>
            <nav class="flex h-9 items-center justify-between" aria-label="Global">
                <div class="flex lg:min-w-0 lg:flex-1/4" aria-label="Global">
                    <a href="?NOPE" class="-m-1.5 p-1.5">
                        <span class="sr-only">knowyourway</span>
                ...
                <div class="hidden lg:flex lg:min-w-0 lg:flex-1 lg:justify-center lg:gap-x-12">
                    <a href="index.php?action=login" class="font-semibold text-gray-900 hover:text-red-600">AdminLogin</a>

                    <a href="index.php?action=formSubmit" class="font-semibold text-gray-900 hover:text-red-600">Game</a>

                    <a href="index.php?action=detente" class="font-semibold text-gray-900 hover:text-red-600">Espace détente</a>

                    <a href="index.php?action=aPropos" class="font-semibold text-gray-900 hover:text-red-600">A propos</a>
                </div>
            </nav>
        </div>
    </div>