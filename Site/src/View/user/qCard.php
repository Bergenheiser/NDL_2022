...
<div class="mt-5">
    <div class="container_QCard">
        <div class="container_section">
            ...
            <p><?php echo htmlspecialchars($question1->get('texteQuestion')) ; ?></p>
            </p>
        </div>
        ...
        <div class="container_answer">
            <div class="div_answer">
                ...
                <p><?php echo htmlspecialchars($reponse1->get('texteReponse')); ?>
                </p>
                </a>
            </div>
            ...
            <div class="div_answer">
                ...
                <p><?php echo htmlspecialchars($reponse2->get('texteReponse')); ?>
                </p>
                </a>
            </div>
            <div class="div_answer">
                <a href="index.php?action=qCard&confirm&lvl=<?php echo $lvl;?>&id=<?php echo $reponse3->get('idReponse'); ?>" class="button">
                <p><?php echo htmlspecialchars($reponse3->get('texteReponse')); ?>
                </p>
                </a>
            </div>
            <script>
